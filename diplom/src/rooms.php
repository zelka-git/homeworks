...
<body>
  ...
  <section class="rooms">
    <div class="container">
      <h3 class="rooms-title">Наши комфортабельные номера!</h3>
      <div class="rooms-block">
        <div class="rooms-images">
          <div class="rooms-images__main slider-for">
            <div class="rooms-images__main-item"><img src="img/page_room/room5-main.jpg" alt="" graggable="false"></div>
            <div class="rooms-images__main-item"><img src="img/page_room/room4-main.jpg" alt="" graggable="false"></div>
            <div class="rooms-images__main-item"><img src="img/page_room/room3-main.jpg" alt="" graggable="false"></div>
            <div class="rooms-images__main-item"><img src="img/page_room/room5-main.jpg" alt="" graggable="false"></div>
            <div class="rooms-images__main-item"><img src="img/page_room/room2-main.jpg" alt="" graggable="false"></div>
        ...
        <div class="rooms-description">
          ...
          <ul class="room__description-cost">
            <li class="room__description-cost__item">Стоимость: 2400р в сутки.</li>
            <li class="room__description-cost__item">с 1 мая по 10 мая — 3000р.</li>
      ...
      <div class="rooms-block">
        <div class="rooms-images">
          <div class="rooms-images__main slider-for1">
          <div class="rooms-images__main-item"><img src="img/page_room/room5-main.jpg" alt="" graggable="false"></div>
            <div class="rooms-images__main-item"><img src="img/page_room/room4-main.jpg" alt="" graggable="false"></div>
            <div class="rooms-images__main-item"><img src="img/page_room/room3-main.jpg" alt="" graggable="false"></div>
            <div class="rooms-images__main-item"><img src="img/page_room/room5-main.jpg" alt="" graggable="false"></div>
      ...
      <div class="rooms-block">
        <div class="rooms-images">
          <div class="rooms-images__main slider-for2">
            <div class="rooms-images__main-item"><img src="img/page_room/room5-main.jpg" alt="" graggable="false"></div>
            <div class="rooms-images__main-item"><img src="img/page_room/room4-main.jpg" alt="" graggable="false"></div>
            <div class="rooms-images__main-item"><img src="img/page_room/room3-main.jpg" alt="" graggable="false"></div>
            <div class="rooms-images__main-item"><img src="img/page_room/room5-main.jpg" alt="" graggable="false"></div>
        ...
        <div class="rooms-description">
          ...
          <ul class="room__description-cost">
            <li class="room__description-cost__item">Стоимость: 1500р в сутки.</li>
            <li class="room__description-cost__item">с 1 мая по 10 мая — 2000р.</li>
      ...
      <div class="rooms-block">
        <div class="rooms-images">
          <div class="rooms-images__main slider-for3">
           <div class="rooms-images__main-item"><img src="img/page_room/room5-main.jpg" alt="" graggable="false"></div>
            <div class="rooms-images__main-item"><img src="img/page_room/room4-main.jpg" alt="" graggable="false"></div>
            <div class="rooms-images__main-item"><img src="img/page_room/room3-main.jpg" alt="" graggable="false"></div>
            <div class="rooms-images__main-item"><img src="img/page_room/room5-main.jpg" alt="" graggable="false"></div>
        ...
        <div class="rooms-description">
          ...
          <ul class="room__description-cost">
            <li class="room__description-cost__item">Стоимость: 800р в сутки.</li>
      ...
      <div class="rooms-block">
        <div class="rooms-images ">
          <div class="rooms-images__main slider-for4">
            <div class="rooms-images__main-item"><img src="img/page_room/room5-main.jpg" alt="" graggable="false"></div>
            <div class="rooms-images__main-item"><img src="img/page_room/room4-main.jpg" alt="" graggable="false"></div>
            <div class="rooms-images__main-item"><img src="img/page_room/room3-main.jpg" alt="" graggable="false"></div>
            <div class="rooms-images__main-item"><img src="img/page_room/room5-main.jpg" alt="" graggable="false"></div>
        ...
        <div class="rooms-description">
          ...
          <ul class="room__description-cost">
            <li class="room__description-cost__item">Стоимость: 300р в сутки с человека.</li>
  ...
  <section class="add-services">
    <div class="container">
      <h3 class="add-services__title">Дополнительные услуги за отдельную плату:</h3>
      <div class="add-services__blocks">
        <div class="add-services__block">
        <div class="add-services__block-main">
          ...
          <div class="add-services__block-top">
            <span class="add-services__block-top__text">Трансфер от Симферополя до Балаклавы - 2000р</span>
          </div>
        </div>
        <!-- /.add-services-block -->
        ...
        <div class="add-services__block-main">
          ...
          <div class="add-services__block-top">
            <span class="add-services__block-top__text">Пользование стиральной машиной - 2000р</span>
          </div>
        </div>
        <!-- /.add-services-block -->
        ...
        <div class="add-services__block-main">
          ...
          <div class="add-services__block-top">
            <span class="add-services__block-top__text">Использование мангала - 2000р</span>
          </div>
        </div>
        <!-- /.add-services-block -->
        ...
        <div class="add-services__block-main">
          ...
          <div class="add-services__block-top">
            <span class="add-services__block-top__text">Пользование баней - 2000р</span>
          </div>
        </div>
        <!-- /.add-services-block -->
        ...
        <div class="add-services__block-main">
          ...
          <div class="add-services__block-top">
            <span class="add-services__block-top__text">Доставак продуктов и товаров - 2000р</span>
          </div>
        </div>
        <!-- /.add-services-block -->
        ...
        <div class="add-services__block-main">
          ...
          <div class="add-services__block-top">
            <span class="add-services__block-top__text">Профессиональный сеанс массажа - 2000р</span>
          </div>
        </div>
        <!-- /.add-services-block -->
        ...
        <div class="add-services__block-main">
          ...
          <div class="add-services__block-top">
            <span class="add-services__block-top__text">Прогулка и рыбалка - 2000р</span>
          </div>
        </div>
        <!-- /.add-services-block -->
        ...
        <div class="add-services__block-main">
          ...
          <div class="add-services__block-top">
            <span class="add-services__block-top__text">?????</span>
          </div>
        </div>
        <!-- /.add-services-block -->
        ...
        <div class="add-services__block-main">
          ...
          <div class="add-services__block-top">
            <span class="add-services__block-top__text">Завтрак 150-200р, обед 250-300р, ужин 200-250р</span>
          </div>
        </div>
        <!-- /.add-services-block -->
      </div>
